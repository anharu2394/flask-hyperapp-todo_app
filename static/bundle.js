...
eval("\nvar content = __webpack_require__(/*! !./node_modules/css-loader?modules!./index.css */ \"./node_modules/css-loader/index.js?modules!./index.css\");\n\nif(typeof content === 'string') content = [[module.i, content, '']];\n\nvar transform;\nvar insertInto;\n\n\n\nvar options = {\"hmr\":true}\n\noptions.transform = transform\noptions.insertInto = undefined;\n\nvar update = __webpack_require__(/*! ./node_modules/style-loader/lib/addStyles.js */ \"./node_modules/style-loader/lib/addStyles.js\")(content, options);\n\nif(content.locals) module.exports = content.locals;\n\nif(false) {}\n\n//# sourceURL=webpack:///./index.css?");
...
"use strict";
eval("\n\n__webpack_require__(/*! babel-polyfill */ \"./node_modules/babel-polyfill/lib/index.js\");\n\nvar _hyperapp = __webpack_require__(/*! hyperapp */ \"./node_modules/hyperapp/src/index.js\");\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nvar _index = __webpack_require__(/*! ./index.css */ \"./index.css\");\n\nvar _index2 = _interopRequireDefault(_index);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nvar state = {\n    todoValue: \"\",\n    todos: []\n};\n\nvar actions = {\n    getTodo: function getTodo() {\n        return function (state, actions) {\n            _axios2.default.get(\"/api/todos\").then(function (res) {\n                console.log(res.data);\n                actions.setTodo(res.data.todos);\n            });\n        };\n    },\n    setTodo: function setTodo(data) {\n        return function (state) {\n            return { todos: data };\n        };\n    },\n    addTodo: function addTodo(todoValue) {\n        return function (state, actions) {\n            console.log(todoValue);\n            var params = new URLSearchParams();\n            params.append(\"value\", todoValue);\n            _axios2.default.post(\"/api/todos\", params).then(function (resp) {\n                console.log(resp.data);\n            }).catch(function (error) {\n                console.log(error);\n            });\n            actions.todoEnd();\n            actions.getTodo();\n        };\n    },\n    onInput: function onInput(value) {\n        return function (state) {\n            state.todoValue = value;\n        };\n    },\n    deleteTodo: function deleteTodo(id) {\n        return function (state, actions) {\n            console.log(id);\n            _axios2.default.delete(\"/api/todos/\" + id).then(function (resp) {\n                console.log(resp.data);\n            }).catch(function (error) {\n                console.log(error);\n            });\n            actions.getTodo();\n        };\n    },\n    checkTodo: function checkTodo(e) {\n        console.log(e);\n        console.log(e.path[1].id);\n        var id = e.path[1].id;\n        console.log(\"/api/todos/\" + id);\n        var params = new URLSearchParams();\n        params.append(\"completed\", e.target.checked);\n        _axios2.default.put(\"/api/todos/\" + id, params).then(function (resp) {\n            console.log(resp.data);\n        }).catch(function (error) {\n            console.log(error);\n        });\n\n        if (e.target.checked == true) {\n            document.getElementById(id).style.opacity = \"0.5\";\n            document.getElementById(\"button_\" + id).style.display = \"inline\";\n        } else {\n            document.getElementById(id).style.opacity = \"1\";\n            document.getElementById(\"button_\" + id).style.display = \"none\";\n        }\n    },\n    todoEnd: function todoEnd() {\n        return function (state) {\n            return { todoValue: \"\" };\n        };\n    }\n};\n\nvar Todos = function Todos() {\n    return function (state, actions) {\n        //   actions.setTodos()\n        // state.todos = actions.setTodos\n        console.log(state.todos);\n        return (0, _hyperapp.h)(\n            \"div\",\n            { \"class\": _index2.default.todos },\n            (0, _hyperapp.h)(\n                \"h1\",\n                null,\n                \"Todo\\u30EA\\u30B9\\u30C8\"\n            ),\n            (0, _hyperapp.h)(\n                \"h2\",\n                null,\n                \"Todo\\u3092\\u8FFD\\u52A0\"\n            ),\n            (0, _hyperapp.h)(\"input\", { type: \"text\", value: state.todoValue, oninput: function oninput(e) {\n                    return actions.onInput(e.target.value);\n                }, onkeydown: function onkeydown(e) {\n                    return e.keyCode === 13 ? actions.addTodo(e.target.value) : '';\n                } }),\n            (0, _hyperapp.h)(\n                \"p\",\n                null,\n                state.todos.length,\n                \"\\u500B\\u306ETodo\"\n            ),\n            (0, _hyperapp.h)(\n                \"ul\",\n                null,\n                state.todos.map(function (todo) {\n                    if (todo.completed) {\n                        return (0, _hyperapp.h)(\n                            \"li\",\n                            { \"class\": _index2.default.checked, id: todo.id },\n                            (0, _hyperapp.h)(\"input\", { type: \"checkbox\", checked: todo.completed, onclick: function onclick(e) {\n                                    return actions.checkTodo(e);\n                                } }),\n                            todo.value,\n                            (0, _hyperapp.h)(\n                                \"button\",\n                                { \"class\": _index2.default.checked, id: \"button_\" + todo.id, onclick: function onclick() {\n                                        return actions.deleteTodo(todo.id);\n                                    } },\n                                \"\\u6D88\\u53BB\"\n                            )\n                        );\n                    } else {\n                        return (0, _hyperapp.h)(\n                            \"li\",\n                            { id: todo.id },\n                            (0, _hyperapp.h)(\"input\", { type: \"checkbox\", checked: todo.completed, onclick: function onclick(e) {\n                                    return actions.checkTodo(e);\n                                } }),\n                            todo.value,\n                            (0, _hyperapp.h)(\n                                \"button\",\n                                { id: \"button_\" + todo.id, onclick: function onclick() {\n                                        return actions.deleteTodo(todo.id);\n                                    } },\n                                \"\\u6D88\\u53BB\"\n                            )\n                        );\n                    }\n                })\n            )\n        );\n    };\n};\nvar view = function view(state, actions) {\n    if (state.todos.length == 0) {\n        actions.getTodo();\n    }\n    return (0, _hyperapp.h)(Todos, null);\n};\n\n(0, _hyperapp.app)(state, actions, view, document.body);\n\n//# sourceURL=webpack:///./index.js?");
...
/***/ "./node_modules/css-loader/index.js?modules!./index.css":
/*!*****************************************************!*\
  !*** ./node_modules/css-loader?modules!./index.css ***!
  \*****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("exports = module.exports = __webpack_require__(/*! ./node_modules/css-loader/lib/css-base.js */ \"./node_modules/css-loader/lib/css-base.js\")(false);\n// imports\n\n\n// module\nexports.push([module.i, \"body {\\n}\\n._20lk0tIQD63ftKWrrtILkj {\\n    margin:auto;\\n}\\nul{\\n  padding: 0;\\n  position: relative;\\n  width: 50%;\\n}\\n\\nul li {\\n  color: black;\\n  border-left: solid 8px orange;/*左側の線*/\\n  background: whitesmoke;/*背景色*/\\n  margin-bottom: 5px;/*下のバーとの余白*/\\n  line-height: 1.5;\\n  border-radius: 0 15px 15px 0;/*右側の角だけ丸く*/\\n  padding: 0.5em;\\n  list-style-type: none!important;\\n}\\nli._2AucKH2sc-e1QOnLftz1Qa {\\n    opacity: 0.5;\\n}\\nbutton {\\n    display: none;\\n}\\nbutton._2AucKH2sc-e1QOnLftz1Qa {\\n    display: inline;\\n}\\n\", \"\"]);\n\n// exports\nexports.locals = {\n\t\"todos\": \"_20lk0tIQD63ftKWrrtILkj\",\n\t\"checked\": \"_2AucKH2sc-e1QOnLftz1Qa\"\n};\n\n//# sourceURL=webpack:///./index.css?./node_modules/css-loader?modules");
